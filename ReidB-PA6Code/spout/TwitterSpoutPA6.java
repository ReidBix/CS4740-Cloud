...
public class TwitterSpoutPA6 extends BaseRichSpout 
{
    ...
    public TwitterSpoutPA6(String key, String secret) {
        _custkey = key;
        _custsecret = secret;
    }

    public TwitterSpoutPA6(String key, String secret, String token, String tokensecret) {
        _custkey = key;
        _custsecret = secret;
        _accesstoken = token;
